        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="relative ml-3">
            <div>
              ...
              <?php else : ?>
                <a href="/PHP/Demo/register" class="<?= urlIs("/PHP/Demo/register") ? 'bg-gray-900' : 'text-gray-300'; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Register</a>
                <a href="/PHP/Demo/login" class="<?= urlIs("/PHP/Demo/login") ? 'bg-gray-900' : 'text-gray-300'; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Login</a>
